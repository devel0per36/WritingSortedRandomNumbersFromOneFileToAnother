package devel0per36.integers;

import devel0per36.integers.io.FilePath;
import devel0per36.integers.io.InputOutputNumbers;
import devel0per36.integers.util.CheckingString;
import devel0per36.integers.util.RandomNumbers;
import devel0per36.integers.util.SortingNumbers;
import devel0per36.integers.util.parse.ParsingNumbers;
import devel0per36.integers.util.parse.ParsingPath;
...
public class App {
    ...
    // Заполнение объекта типа FilePath путями к файлу
